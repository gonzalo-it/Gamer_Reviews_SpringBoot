...
public class JuegoController {
 ...
 // ============================================================
    ...
    public ResponseEntity<DataResponse<List<JuegoRanking>>> getRanking(HttpServletRequest request) {
    	String baseUrl = request.getScheme() + "://" 
                + request.getServerName() + ":" 
                + request.getServerPort();
        List<JuegoRanking> ranking = juegoService.getTopRanking(baseUrl);
        DataResponse<List<JuegoRanking>> response =
                new DataResponse<>(true, 200, "Lista de juegos", ranking);
